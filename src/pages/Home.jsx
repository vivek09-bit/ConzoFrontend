      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <footer className="bg-gray-800 text-white py-8">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-xl font-bold mb-4">About ImgPdfHub</h2>
            <p className="mb-4">
              ImgPdfHub provides free online tools for converting between image formats and PDFs. Our tools work on any device and require no registration.
            </p>
            <div className="text-sm text-gray-400">
              <p>© {new Date().getFullYear()} ImgPdfHub. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </main>
