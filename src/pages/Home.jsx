...
const tools = [
  ...
  { to: "/compress-image", label: "Compress Image", desc: "Reduce JPG, PNG, WEBP Image size", icon: "🗜️" },
...
const HomePage = () => {
  ...
  <link rel="icon" href={`${DOMAIN}favicon.ico`} />
      ...
      <section className="text-center py-12 px-4">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-4 text-indigo-500">Welcome to IMG PDF HUB</h1>
        <p className="text-lg md:text-xl text-gray-700 mb-10">
          Convert your files quickly and easily with our fast and free online tools and easy to use also.
        </p>
