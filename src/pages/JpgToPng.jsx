...
const JpgToPng = memo(() => {
    ...
    const handleConvert = async () => {
        ...
        try {
            const response = await axios.post(
                `${VITE_BACKEND_DOMAIN}/api/jpg-to-png`,
                formData,
                { responseType: "arraybuffer" }
            );
            // Assume backend returns a zip if multiple files, or a single png if one file
            let urls = [];
            if (files.length === 1) {
    ...
    return (
        <main>
            <Helmet>
                <title>JPG to PNG Converter | Free, Fast & Secure Online Tool</title>
                <meta
                    name="description"
                    content="Convert JPG to PNG online free – no registration, no watermark. Fast and secure JPG to PNG tool to convert images to high-quality PNG."
                />
                <meta
                    name="keywords"
                    content="jpg to png, convert jpg to png, image to png, online jpg to png converter, free jpg to png"
                />
                <meta name="robots" content="index, follow" />
                <link rel="canonical" href="https://yourdomain.com/jpg-to-png" />
                {/* Open Graph for Facebook & LinkedIn */}
                <meta property="og:type" content="website" />
                <meta property="og:title" content="JPG to PNG Converter – Free & Secure" />
                <meta
                    property="og:description"
                    content="Easily convert JPG images into PNG files online. 100% free, fast and secure. No email required!"
                />
                <meta property="og:url" content="https://yourdomain.com/jpg-to-png" />
                <meta
                    property="og:image"
                    content="https://yourdomain.com/assets/og-jpg-to-png.png"
                />
                {/* Twitter Card */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="JPG to PNG – Free Online Converter" />
                <meta
                    name="twitter:description"
                    content="Convert JPG to PNG online for free. Fast, easy, and secure. No watermark. No signup."
                />
                <meta
                    name="twitter:image"
                    content="https://yourdomain.com/assets/og-jpg-to-png.png"
            ...
            <section className="py-8 px-4 flex flex-col items-center">
                <div className="text-center mb-8">
                    ...
                    <p className="text-lg text-gray-500 max-w-2xl mx-auto">
                        Convert JPG images to PNG online for free. No registration, no watermark. Instant results.
                    </p>
