...
const JpgToJpeg = memo(() => {
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            // Assume backend returns a zip if multiple files, or a single jpeg if one file
            let urls = [];
            if (files.length === 1) {
            ...
            setJpegUrls(urls);
            setFeedback("JPEG file(s) ready to download!");
        } catch (error) {
    ...
    useEffect(() => {
        if (jpegUrls.length && downloadLinkRef.current) {
    ...
    return (
        <main>
            <Helmet>
                <title>JPG to JPEG Converter | Free, Fast & Secure Online Tool</title>
                <meta
                    name="description"
                    content="Convert JPG to JPEG online free – no registration, no watermark. Fast and secure JPG to JPEG tool to convert images to high-quality JPEG."
                />
                <meta
                    name="keywords"
                ...
                <meta name="twitter:title" content="JPG to JPEG – Free Online Converter" />
                <meta
                    name="twitter:description"
                    content="Convert JPG to JPEG online for free. Fast, easy, and secure. No watermark. No signup."
                />
                <meta
                    name="twitter:image"
                    content="https://imgpdfhub.com/assets/og-jpg-to-jpeg.png"
            ...
            <section className="py-8 px-4 flex flex-col items-center">
                <div className="text-center mb-8">
                    ...
                    <p className="text-lg text-gray-500 max-w-2xl mx-auto">
                        Convert JPG images to JPEG online for free. No registration, no watermark. Instant results.
                    </p>
                ...
                {/* Download JPEG or ZIP */}
                {jpegUrls.length > 0 && (
                    <div className="mt-2 flex flex-row items-center justify-center gap-4">
                        <a
                            href={jpegUrls[0]}
                            download={files.length === 1 ? "converted.jpeg" : "converted.zip"}
                            ...
                            tabIndex={0}
                        >
                            Download {files.length === 1 ? "JPEG" : "ZIP"}
                        </a>
                        <button
