...
function AvifToJpg() {
    ...
    return (
        <main>
            <Helmet>
                <title>AVIF to JPG Converter | Free, Fast & Secure Online Tool</title>
                <meta
                    name="description"
                    content="Convert AVIF to JPG online free – no registration, no watermark. Fast and secure AVIF to JPG tool to convert images to high-quality JPG."
                />
                <meta
                    name="keywords"
                ...
                <meta name="twitter:title" content="AVIF to JPG – Free Online Converter" />
                <meta
                    name="twitter:description"
                    content="Convert AVIF to JPG online for free. Fast, easy, and secure. No watermark. No signup."
                />
                <meta
                    name="twitter:image"
                    content="https://yourdomain.com/assets/og-avif-to-jpg.png"
            ...
            <section className="py-8 px-4 flex flex-col items-center">
                <div className="text-center mb-8">
                    ...
                    <p className="text-lg text-gray-500 max-w-2xl mx-auto">
                        Convert AVIF images to JPG online for free. No registration, no watermark. Instant results.
                    </p>
                ...
                >
                    ...
                    <p className="text-gray-400 text-sm mb-2">
                        or drag & drop AVIF files here
                    </p>
                    <p className="text-gray-400 text-xs">
                        Supported: AVIF only, up to 20 files, max 50MB total
                    </p>
                </div>
