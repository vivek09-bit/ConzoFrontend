...
import { FaSpinner, FaCheckCircle, FaRegTrashAlt, FaArrowUp, FaArrowDown } from "react-icons/fa";
...
const AvifToPng = memo(() => {
    ...
    const [estimatedTime, setEstimatedTime] = useState(8); // Initialize estimated time
    ...
    const startProgressSimulation = () => {
        ...
        setStep(0);
        setShowSuccess(false);
        setEstimatedTime(8); // Reset estimated time
