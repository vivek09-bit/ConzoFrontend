...
const PngToJpg = memo(() => {
    ...
    const handleConvert = async () => {
        ...
        try {
            const response = await axios.post(
                `${VITE_BACKEND_DOMAIN}/api/png-to-jpg`,
                formData,
    ...
    return (
        <main className="bg-gray-100 min-h-screen flex flex-col items-center">
            <Helmet>
                <title>PNG to JPG Converter | Free, Fast & Secure Online Tool</title>
                <meta
                    name="description"
                    content="Convert PNG to JPG online free – no registration, no watermark. Fast and secure PNG to JPG tool to convert images to high-quality JPG."
                />
                <meta
                    name="keywords"
                    content="png to jpg, convert png to jpg, image to jpg, online png to jpg converter, free png to jpg"
                />
                <meta name="robots" content="index, follow" />
                <link rel="canonical" href="https://imgpdfhub.com/png-to-jpg" />
                {/* Open Graph for Facebook & LinkedIn */}
                <meta property="og:type" content="website" />
                <meta property="og:title" content="PNG to JPG Converter – Free & Secure" />
                <meta
                    property="og:description"
                    content="Easily convert PNG images into JPG files online. 100% free, fast and secure. No email required!"
                />
                <meta property="og:url" content="https://imgpdfhub.com/png-to-jpg" />
                <meta
                    property="og:image"
                    content="https://imgpdfhub.com/assets/og-png-to-jpg.png"
                />
                {/* Twitter Card */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="PNG to JPG – Free Online Converter" />
                <meta
                    name="twitter:description"
                    content="Convert PNG to JPG online for free. Fast, easy, and secure. No watermark. No signup."
                />
                <meta
                    name="twitter:image"
                    content="https://imgpdfhub.com/assets/og-png-to-jpg.png"
            ...
            <section className="py-8 px-4 flex flex-col items-center">
                <div className="text-center mb-8">
                    ...
                    <p className="text-lg text-gray-500 max-w-2xl mx-auto">
                        Convert PNG images to JPG online for free. No registration, no watermark. Instant results.
                    </p>
                ...
                >
                    ...
                    <p className="text-gray-400 text-sm mb-2">
                        or drag & drop PNG files here
                    </p>
                    <p className="text-gray-400 text-xs">
                        Supported: PNG only, up to 20 files, max 50MB total
                    </p>
                </div>
